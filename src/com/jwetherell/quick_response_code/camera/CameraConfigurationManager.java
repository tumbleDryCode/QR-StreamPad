...
public final class CameraConfigurationManager {
    ...
    void setDesiredCameraParameters(Camera camera) {
        ...
        initializeTorch(camera, parameters);
    ...
    private static void initializeTorch(Camera acam, Camera.Parameters parameters) {
    ...
    public String doSetTorch(Camera.Parameters parameters, boolean newSetting) {
        String flashMode = "";
        if (newSetting) {
 flashMode = findSettableValue(parameters.getSupportedFlashModes(), Camera.Parameters.FLASH_MODE_RED_EYE);
